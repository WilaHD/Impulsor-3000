...
!system "bash -c 'cp ../../libs/lame/windows-x64/libmp3lame.dll ./install_dir/libmp3lame.dll'"
!system "bash -c 'cp ../../libs/pdfium/win-x64/pdfium.dll ./install_dir/pdfium/win-x64/pdfium.dll'"
